...
public class ProductSummaryController {
    ...
    private final ProductSummaryServiceCustom productSummaryServiceCustom;

    @Autowired
    public ProductSummaryController(ProductSummaryApi productSummaryApi, ProductSummaryServiceCustom productSummaryServiceCustom) {
        this.productSummaryApi = productSummaryApi;
        this.productSummaryServiceCustom = productSummaryServiceCustom;
    }
